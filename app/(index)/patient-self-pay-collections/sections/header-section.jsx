        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col items-start lg:col-span-6 xl:col-span-7">
            ...
            <nav className="flex items-center gap-2 text-xs font-semibold text-slate-700 sm:text-sm">
              ...
              <a href="provider" className="text-[#0f2d9e] hover:underline">
                Provider Services
              </a>
              <span className="text-slate-400">/</span>
            ...
            {/* Main Heading */}
            <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-[#0b132b]">
            ...
            <p className="mt-5 max-w-2xl text-sm leading-relaxed text-slate-800 sm:text-base">
              Support patient balance outreach, self-pay follow-up, payment
              coordination, documentation, and account resolution workflows with
              a trained healthcare operations team focused on clarity and
              respect.
            </p>
