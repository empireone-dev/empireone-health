...
export default function PayerHowWeWorkSection() {
    ...
    <div>
      <section className="w-full bg-[#f0f3ff] px-6 py-16 sm:px-12 lg:px-16 lg:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            <img
              src="/images/provider-data-managemen.webp"
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-bold leading-snug tracking-tight text-[#0b132b] sm:text-3xl lg:text-[32px]">
             Need payer operations support you can measure?
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
             Discuss member services, enrollment support, or provider data management workflows with a team built for clear ownership, QA visibility, and accountable reporting.
            </p>
            <ul className="mt-6 space-y-3.5">
              {[
                "Member inquiry and service request routing",
                "Enrollment queue support and status tracking",
                "Provider data validation and directory maintenance",
                "QA reporting, escalation paths, and pilot-to-scale support",
              ].map((text, i) => (
                <motion.li
                  key={text}    
                  initial={
