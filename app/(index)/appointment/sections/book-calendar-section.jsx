...
export default function BookCalendarSection() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // 3. Create End Time Date object (Assuming a 1-hour call)
                        ...
                        <div className="px-4 py-5 sm:px-8 sm:py-7 lg:px-10 lg:py-8">
                            ...
                            >
                                <div>
                                    ...
                                    <div className={`rounded-2xl border bg-slate-50/70 p-3 transition-colors sm:p-4 ${errors.date ? 'border-rose-300' : 'border-slate-100'}`}>
                                                        ...
                                                        >
                                                            {day ? (
                                                                <motion.button
                                                                    ...
                                                                    className={`relative flex h-8 w-8 flex-col items-center justify-center rounded-lg text-xs font-semibold sm:h-9 sm:w-9 sm:text-sm ${isSelected
                                ...
                                <div className="flex flex-col">
                                    <div className="mb-5">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-xl border bg-slate-50/70 px-3 py-2 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-indigo-100 sm:px-4 sm:py-2.5 sm:text-base ${errors.name ? 'border-rose-400 focus:border-rose-400' : 'border-slate-200 focus:border-indigo-400'
                                                }`}
                                        />
                                    </div>
                                    <div className="mb-5">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-xl border bg-slate-50/70 px-3 py-2 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-indigo-100 sm:px-4 sm:py-2.5 sm:text-base ${errors.email ? 'border-rose-400 focus:border-rose-400' : 'border-slate-200 focus:border-indigo-400'
                                                }`}
                                        />
                                    </div>
                                        ...
                                        {TIME_SLOTS.map((slot) => {
                                            ...
                                            return (
                                                <motion.button
                                                    ...
                                                    whileTap={{ scale: 0.92 }}
                                                    className={`rounded-xl border py-2 text-xs font-semibold transition-colors duration-150 sm:py-2.5 sm:text-sm ${isSelected
