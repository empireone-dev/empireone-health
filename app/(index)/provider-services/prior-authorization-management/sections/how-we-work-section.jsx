    ...
    <div>
      <section className="w-full bg-[#f0f3ff] px-6 py-16 sm:px-12 lg:px-16 lg:py-24">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            <Image
              src="/images/prior-authorization-management.webp"
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
              The support model is designed around your specialties, payer mix,
              systems, turnaround goals, clinical handoff rules, and reporting
              expectations.
            </p>
