        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-bold leading-snug tracking-tight text-[#0b132b] sm:text-3xl lg:text-[32px]">
              A structured access workflow your team can scale.
            </h2>
            {/* Removed max-w-2xl so text spans full column width */}
            <p className="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
              The support model is designed around your scheduling rules,
              referral sources, specialties, provider templates, patient
              outreach standards, and reporting expectations.
            </p>
            <ul className="mt-6 space-y-3.5 w-full">
              {[
                "Appointment request intake and scheduling queue ownership",
                "Referral review, routing, and missing information follow-up",
                "Patient reminders, rescheduling, and no-show follow-up",
                "QA sampling, aging reports, and escalation visibility",
              ].map((text, i) => (
                <motion.li
                  key={text}
                  initial={
