...
export default function ProviderHowWeWorkSection() {
    ...
    <div>
      <section className="w-full bg-[#f0f3ff] px-6 py-16 sm:px-12 lg:px-16 lg:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            <Image
              src="/images/EmpireOne-agent.webp"
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-bold leading-snug tracking-tight text-[#0b132b] sm:text-3xl lg:text-[32px]">
              Structured provider support across the entire revenue cycle from
              scheduling to reporting.
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
              EmpireOneHealth builds provider operations support around your
              queues, systems, payer rules, documentation standards, and
              escalation requirements.
            </p>
            <ul className="mt-6 space-y-3.5">
              {[
                "Workflow scope and queue ownership",
                "Training around payer and documentation rules",
                "QA sampling, KPI reporting, and escalation visibility",
                "Focused pilot path before scaling support",
              ].map((text, i) => (
                <motion.li
                  key={text}
                  initial={
