...
const CARD_DATA = [
  {
    ...
    description:
      "Support enrollment intake, application completeness checks, missing information review, and queue routing.",
  },
  {
    title: "Member Updates",
    description:
      "Assist demographic updates, plan changes, eligibility status notes, documentation updates, and record maintenance.",
  },
  {
    title: "Status Tracking",
    description:
      "Track pending applications, member update requests, documentation needs, exceptions, and processing outcomes.",
  },
];
