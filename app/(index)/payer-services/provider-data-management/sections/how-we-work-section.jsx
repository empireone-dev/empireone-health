    ...
    <div>
      <section className="w-full bg-[#f0f3ff] px-6 py-16 sm:px-12 lg:px-16 lg:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            <img
              src="/images/structured-provider-data-workflow.webp"
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-bold leading-snug tracking-tight text-[#0b132b] sm:text-3xl lg:text-[32px]">
              A structured provider data workflow with measurable controls.
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
              The support model is aligned to your provider data rules,
              directory standards, source documentation requirements, change
              request logic, exception paths, and reporting cadence.
            </p>
            <ul className="mt-6 space-y-3.5">
              {[
                "Provider record update and directory queue ownership",
                "Source documentation and data validation support",
                "Duplicate, missing-field, and exception escalation",
                "QA sampling, aging visibility, and data quality reporting",
              ].map((text, i) => (
                <motion.li
                  key={text}
                  initial={
