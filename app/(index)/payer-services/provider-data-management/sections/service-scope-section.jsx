...
const TOP_CARDS = [
  {
    badge: "Update",
    title: "Provider Record Maintenance",
    desc: "Support changes to names, addresses, phone numbers, practice locations, specialties, identifiers, and network status.",
  },
  {
    badge: "Verify",
    title: "Source Data Validation",
    desc: "Check submitted information against required documentation, payer rules, directory standards, and internal workflows.",
  },
];
...
const FOUNDATION_CARDS = [
  {
    ...
    desc: "Assist with directory updates, provider visibility checks, location details, accepting-patient status, and display accuracy.",
  },
  {
    badge: "Requests",
    title: "Change Request Routing",
    desc: "Route new requests, missing information items, credentialing handoffs, and provider update exceptions to the right queue.",
  },
  {
    badge: "Clean",
    title: "Duplicate & Exception Review",
    desc: "Flag duplicate records, inconsistent fields, expired information, unresolved updates, and items needing internal review.",
  },
];
