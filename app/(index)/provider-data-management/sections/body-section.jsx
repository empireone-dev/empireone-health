...
const CARD_DATA = [
  {
    ...
    description:
      "Support provider demographic, location, specialty, contact, network, and status updates across defined queues.",
  },
  {
    title: "Data Validation",
    description:
    "Review submitted changes, source documentation, required fields, duplicate records, and internal data standards.",
    },
  {
    title: "Directory Accuracy",
    description:
      "Help maintain provider directory information, change request visibility, unresolved exceptions, and QA reporting.",
  },
];
